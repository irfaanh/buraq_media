...
export default async function CategoryNewsPage({ params, searchParams }: PageProps) {
  ...
  // Get news for this category with pagination
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Category Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">{decodedName}</h1>
            ...
            {news.length > 0 ? (
              <>
                ...
                <Pagination
                  ...
                  baseUrl={`/category/${encodeURIComponent(decodedName)}`}
                />
              </>
            ) : (
              <Card>
