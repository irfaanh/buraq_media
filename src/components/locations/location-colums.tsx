...
export const locationColumns: ColumnDef<Location>[] = [
  ...
  },
  {
    ...
    header: "Actions",
    cell: ({ row }) =>
      row.original && <LocationActions location={row.original} />,
  },
];

export const LocationActions = ({ location }: { location: Location }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Edit Dialog */}
      <LocationFormDialog open={openEdit} openChange={setOpenEdit} location={location} />
